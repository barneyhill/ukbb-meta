...
main() {
    ...
    docker run -e cohort=$cohort -v ~/:/mnt/DNAnexus wzhou88/saige:1.1.6.1 step2_SPAtests.R \
									     --GMMATmodelFile /mnt/DNAnexus/model_file \
									     --varianceRatioFile /mnt/DNAnexus/variance_ratios \
                                                                             --sparseGRMFile /mnt/DNAnexus/GRM \
